    ...
    <form onSubmit={signup} className='px-5'>
      ...
      <div className='mb-[90px]'>
        <p className='text-xl font-bold'>비밀번호</p>
          <input className='w-[350px] h-[44px] px-3 py-2.5 border border-st-gray-05 rounded mr-3' ref={password_ref} placeholder='비밀번호 입력'/>  
      </div>
      <div className='mb-[160px]'>
        <p className='text-xl font-bold'>비밀번호 재확인</p>
          <input className='w-[350px] h-[44px] px-3 py-2.5 border border-st-gray-05 rounded mr-3' ref={check_ref} placeholder='비밀번호 입력'/>
      </div>
